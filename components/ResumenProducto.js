  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
        ...
        <div>
            <button
                type="button"
                className="bg-sky-700 px-5 py-2 text-white rounded-md font-bold 
                uppercase shadow-md w-full flex gap-2"
                onClick={() => {
            ...
            <button
                type="button"
                className="bg-red-700 px-5 py-2 text-white rounded-md font-bold 
                uppercase shadow-md w-full mt-3 flex gap-2"
